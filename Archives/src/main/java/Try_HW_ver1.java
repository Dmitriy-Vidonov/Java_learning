...
public class Try_HW_ver1 {
    private static final byte[] buffer = new byte[4096 * 1024]; //буфер на 4 мб

    //метод для копирования входного потока в выходной
    ...
    public static void main(String[] args) throws Exception {
        ZipFile primaryArchive = new ZipFile("test.zip"); //переменная ZipFile для чтения исходного архива
